...
El [dataset original](data/raw/synthetic_depression_dataset_v2_5000.csv) se incorporó al repositorio.
...
* Los países con menor promedio de días soleados presentan una mayor proporción de personas con depresión severa.
...
- [Dataset original](data/raw/synthetic_depression_dataset_v2_5000.csv)
- [Dataset limpio](data/data_limpio.csv)
